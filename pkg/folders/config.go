...
// WatchConfig is the folders event-buffer setting. Interval is retained for
// configs written by pre-per-folder-poller releases; new configs should set
// FolderConfig.Interval instead.
